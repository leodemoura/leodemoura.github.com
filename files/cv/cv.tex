...
% ===== Layout =================================================================
\usepackage[top=0.85in,bottom=1in,left=0.95in,right=0.95in]{geometry}
...
% ===== Colors =================================================================
\definecolor{HeaderColor}{HTML}{0B2444}
...
\hypersetup{
  ...
  urlcolor=LinkColor,
  citecolor=LinkColor,
  pdfauthor={Leonardo de Moura},
  pdftitle={Leonardo de Moura -- Curriculum Vitae}
}

% ===== Section styling ========================================================
\titleformat{\section}
  {\large\bfseries\color{HeaderColor}}{}{0pt}{}
  [{\vspace{-1.4ex}{\color{RuleColor}\rule{\linewidth}{0.5pt}}}]
...
\fancyfoot[L]{\small\itshape Leonardo de Moura}
\fancyfoot[R]{\small\thepage}

% ===== Column type for ragged-right X =========================================
\newcolumntype{Y}{>{\raggedright\arraybackslash}X}

% ===== Entry macros ===========================================================
\newcommand{\daterange}[2]{%
  \ifstrempty{#2}{\textbf{#1\,\textendash\,present}}{%
    \ifstrequal{#2}{ }{\textbf{#1}}{\textbf{#1\,\textendash\,#2}}%
  }%
}

% Single-line entry: dates + title (used when subtitle is empty).
\newcommand{\joboneline}[3]{%
  \noindent
  \begin{tabularx}{\linewidth}{@{}p{0.24\linewidth}@{\hspace{0.6em}}Y@{}}
    \daterange{#1}{#2} & #3
  \end{tabularx}\par\smallskip
}

% Two-line entry: dates + title + subtitle.  Subtitle may itself use
% `\\ &` to span multiple lines (preserves the original CV's awards
% formatting).
\newcommand{\job}[4]{%
  \ifstrempty{#4}{\joboneline{#1}{#2}{#3}}{%
    \noindent
    \begin{tabularx}{\linewidth}{@{}p{0.24\linewidth}@{\hspace{0.6em}}Y@{}}
      \daterange{#1}{#2} & #3 \\
      & #4
...
% ===== Header =================================================================
\begin{center}
  {\Huge\bfseries\color{HeaderColor} Leonardo de Moura}\\[0.4ex]
  {\large\itshape Curriculum Vitae}
\end{center}
\vspace{0.6ex}{\color{RuleColor}\rule{\linewidth}{0.6pt}}
\vspace{0.4ex}

% ===== Personal data ==========================================================
\noindent\begin{tabularx}{\linewidth}{@{}l@{\hspace{0.8em}}X@{}}
  \textbf{Address}     & 18530 NE 53rd CT, Redmond, WA 98052, USA \\
  \textbf{Phone}       & (425) 647-1990 \\
  \textbf{Email}       & \href{mailto:leodemoura0@gmail.com}{leodemoura0@gmail.com} \\
  \textbf{Homepage}    & \url{http://leodemoura.github.io} \\
  \textbf{GitHub}      & \url{https://github.com/leodemoura} \\
  \textbf{LinkedIn}    & \url{https://www.linkedin.com/in/leonardo-de-moura-26a27b5/} \\
  \textbf{Wikipedia}   & \url{https://en.wikipedia.org/wiki/Leonardo_de_Moura} \\
  \textbf{Scholar}     & \url{https://scholar.google.com/citations?user=CwazDKgAAAAJ&hl=en} \\
  \textbf{Nationality} & American and Brazilian \\
\end{tabularx}

\section*{Experience and Job History}

\job{04/2023}{}{Senior Principal Applied Scientist at AWS, Redmond, WA, USA}{}
\job{07/2023}{}{Chief Architect and co-founder Lean FRO (nonprofit), USA}{}
...
\begin{itemize}[leftmargin=*,itemsep=0.8ex]
\item {\em The Lean Proof Assistant and Programming Language}, \url{https://lean-lang.org}.
...
The project has been used by six Fields Medalists, and is featured in many popular science magazines, including
{\bf Nature}~\footnote{\url{https://www.nature.com/articles/d41586-023-00487-2}}\textsuperscript{,}\footnote{\url{https://www.nature.com/articles/d41586-021-01627-2}},
  ...
  Many additional links to articles and interviews are available at \url{https://lean-lang.org/fro/about}.
...
\item {\em Z3} is an efficient satisfiability modulo theories (SMT) solver, \url{http://github.com/z3prover/z3}.
  ...
  The project has received numerous awards, including the {\em Programming Languages Software Award} from ACM SIGPLAN.
  Z3 is widely used in industry (e.g., Microsoft, AWS, Apple, Meta, Google, to name a few).
\end{itemize}
...
\award{2025}{ }{Programming Languages Software Award for Lean from ACM SIGPLAN.}{}
\award{2025}{ }{Skolem Award}{for the paper ``The Lean Theorem Prover''. The Skolem award is given to the papers that have passed the test of time by being among the most influential in the field of automated deduction.}
...
\award{2017}{ }{Skolem Award}{for the paper ``Efficient E-Matching for SMT Solvers''. The Skolem award is given to the papers that have passed the test of time by being among the most influential in the field of automated deduction.}
...
\award{2010}{ }{Haifa Verification Conference Award.}{The HVC award is given to the most influential work in the last five years in the scope of software and hardware verification and testing.}
...
\award{2000}{ }{Second Prize in the ACM'2000 Student Research Contest}{Association for Computing Machinery (ACM)}

\section*{Education}

\noindent\begin{tabularx}{\linewidth}{@{}p{0.10\linewidth}@{\hspace{0.6em}}X@{}}
  \textbf{04/2000} & Ph.D. in Computer Science. \\
                   & Thesis topic: ``Automating the Generation of Program Analysis and Verification Tools.'' \\
                   & Pontifical Catholic University of Rio de Janeiro (PUC-Rio), Brazil. \\[0.8ex]
  \textbf{03/1996} & M.Sc. in Computer Science. \\
                   & Thesis topic: ``Visual Development Environments.'' \\
                   & Pontifical Catholic University of Rio de Janeiro (PUC-Rio), Brazil. \\[0.8ex]
  \textbf{01/1994} & Computer Engineer. \\
                   & Pontifical Catholic University of Rio de Janeiro (PUC-Rio), Brazil. \\
\end{tabularx}

\section*{Publications}

\begin{enumerate}[leftmargin=*,itemsep=0.5ex,topsep=0.6ex]

\item K. Morrison and L. de Moura,
    {\em grind: An SMT-Inspired Tactic for Lean~4},
    13th International Joint Conference in Automated Reasoning (IJCAR), 2026.

\item C. Barrett, S. Chaudhuri, F. Montesi, J. Grundy, P. Kohli, L. de Moura, A. Rademaker and S. Yingchareonthawornchai,
      {\em CSLib: The Lean Computer Science Library},
      arXiv:2602.04846, to appear in Communications of the ACM, 2026.
...
\item D. Selsam, M. Lamm, B. B\"unz, P. Liang, L. de Moura and D. Dill,
...
\item K. Hoder, N. Bjorner, and L. de Moura,
      {\em $\mu$Z -- an efficient engine for fixed points with constraints},
...
\item C. Wintersteiger, Y. Hamadi and L. de Moura,
      {\em Efficiently Solving Quantified Bit-Vector Formulas},
...
\item N. Bjorner, B. Dutertre and L. de Moura,
      {\em Accelerating Lemma Learning using Joins -- DPLL(Join)},
...
\item L. de Moura and N. Bjorner,
      {\em Relevancy Propagation}, MSR Technical Note, 2007.

\item L. de Moura and N. Bjorner,
      {\em Efficient E-matching for SMT solvers},
      International Conference on Automated Deduction (CADE), 2007.

\item L. de Moura and N. Bjorner,
      {\em Model-based Theory Combination},
      Workshop on Satisfiability Modulo Theories (SMT), 2007.

\item C. Barrett, L. de Moura and A. Stump,
      {\em Design and Results of the Second Satisfiability Modulo Theories Competition (SMT-COMP 2006)},
      Journal of Formal Methods in System Design, 2007.

\item L. de Moura, B. Dutertre and N. Shankar,
      {\em A Tutorial on Satisfiability Modulo Theories},
      Conference on Computer Aided Verification (CAV), 2007.
...
\item M. F. Fontoura, L. de Moura, S. Crespo and C. J. P. de Lucena,
      ...
      World Wide Web WWW Baltzer Science, Bussum, Holland, 2000.
...
\REF{Dr.\ Thomas Ball}
    {Ex-Microsoft/Bell Labs, ACM Fellow, WA, USA \\
     email: \href{mailto:thomas.j.ball@outlook.com}{thomas.j.ball@outlook.com}}

\REF{Prof.\ Jeremy Avigad}
    {Carnegie Mellon University, PA, USA \\
     email: \href{mailto:avigad@cmu.edu}{avigad@cmu.edu} \\
     homepage: \url{http://www.andrew.cmu.edu/user/avigad/}}

\REF{Dr.\ Natarajan Shankar}
    {SRI International, CA, USA \\
     email: \href{mailto:shankar@csl.sri.com}{shankar@csl.sri.com} \\
