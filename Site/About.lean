...
He is the main architect of several automated reasoning tools: [Lean](https://lean-lang.org), [Z3](https://github.com/Z3Prover/z3), [Yices 1.0](http://yices.csl.sri.com/) and [SAL](http://sal.csl.sri.com). Leo's work in automated reasoning has been acknowledged with a series of prestigious awards, including the [CAV](http://i-cav.org/2021/cav-award/), [Haifa](https://www.research.ibm.com/haifa/conferences/hvc2010/award.shtml), and [Herbrand](http://www.cadeinc.org/Herbrand-Award) awards, as well as the [ACM SIGPLAN Programming Languages Software Award](https://www.sigplan.org/Awards/Software/) twice for Z3 and Lean.

# Awards

- (2025) [ACM SIGPLAN Programming Languages Software Award](https://www.sigplan.org/Awards/Software/) for Lean.
- (2025) [Skolem Award](https://cadeinc.org/Skolem-Award) for the paper "The Lean Theorem Prover" that has passed the test of time.
- (2021) Distinguished paper award at [PLDI](https://pldi21.sigplan.org/track/pldi-2021-papers) for "Perceus: Garbage Free Reference Counting with Reuse".
- (2021) [CAV Award](http://i-cav.org/2021/cav-award/) for pioneering contributions to the foundations of the theory and practice of SMT.
- (2019) [Herbrand award](http://www.cadeinc.org/Herbrand-Award) for numerous and important contributions to SMT solving.
...
- (2017) [Skolem Award](http://www.cadeinc.org/Skolem-Award) for the paper "Efficient E-Matching for SMT Solvers" that has passed the test of time.
- (2015) [ACM SIGPLAN Programming Languages Software Award](https://www.sigplan.org/Awards/Software/) for Z3.
- (2014) "The most influential tool paper in the first 20 years of TACAS" for the paper: _Z3: An Efficient SMT Solver_. (TACAS conference)
