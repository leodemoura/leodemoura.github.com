...
#doc (Post) "Cray Colloquium at the University of Minnesota" =>
%%%
...
The talk covers the convergence of formal verification and AI: how Lean became the platform every AI math system trains on, what machine-checked proofs mean for software reliability,
and where proof automation is heading. It includes live demos of `grind`, the Radix verified DSL built by 10 AI agents in a weekend, and examples from Cedar, SymCrypt, and Veil.

[Slides](/static/minnesota2026/)
